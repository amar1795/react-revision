...
const CryptoDetails = () => {
  ...
  // without using isfetching the component was being reendered before the data could be fetched and was giving error " Cannot read properties of undefined (reading 'name')"
  if (isFetching) {
        ...
        <Col className='stats-container'>
          ...
          <Col className='other-stats-info'>
            <Col className='coin-value=statistics-heading'>
              ...
              <p>
                An overview showing the stats of all cryptocoins  
              </p>
